...
_0x0:
	.DB  0x70,0x65,0x72,0x69,0x6F,0x64,0x20,0x3D
	.DB  0x20,0x0,0x68,0x65,0x6C,0x6C,0x6F,0x20
	.DB  0x77,0x6F,0x72,0x6C,0x64,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020060:
	.DB  0x1
...
; 0000 0018     ++timer1_counter;
	LDI  R26,LOW(_timer1_counter_G000)
	LDI  R27,HIGH(_timer1_counter_G000)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
...
; 0000 0023             + ((unsigned long) timer1_counter) ;
	...
	MOVW R26,R30
	MOVW R24,R22
	LDS  R30,_timer1_counter_G000
	LDS  R31,_timer1_counter_G000+1
	CLR  R22
	CLR  R23
	CALL __ADDD12
	__PUTD1S 2
...
; 0000 0026     timer1_counter = 0;
	LDI  R30,LOW(0)
	STS  _timer1_counter_G000,R30
	STS  _timer1_counter_G000+1,R30
