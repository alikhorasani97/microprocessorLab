...
; 0000 0026     if (active>=4)
	LDS  R26,_active_G000
	LDS  R27,_active_G000+1
	SBIW R26,4
	BRLT _0x10
; 0000 0027         active = 0;
	LDI  R30,LOW(0)
	STS  _active_G000,R30
	STS  _active_G000+1,R30
; 0000 0028 
; 0000 0029     PORTC = 0x0F & ~(1<<active);
_0x10:
	LDS  R30,_active_G000
	LDI  R26,LOW(1)
	CALL __LSLB12
	COM  R30
	ANDI R30,LOW(0xF)
...
; 0000 002A     PORTD = bcd(t_ary[active]);
	LDS  R30,_active_G000
	LDS  R31,_active_G000+1
	SUBI R30,LOW(-_t_ary)
	SBCI R31,HIGH(-_t_ary)
	LD   R26,Z
	LDI  R27,0
	RCALL _bcd
	OUT  0x12,R30
; 0000 002B 
; 0000 002C     active++;
	LDI  R26,LOW(_active_G000)
	LDI  R27,HIGH(_active_G000)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
